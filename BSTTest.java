...
public class BSTTest extends student.TestCase {
    ...
    public void testFindByValue() {
        // CASE 1: ADD TO ROOT
        test2BST.insert(1, 10);
        assertEquals(10, test2BST.findByValue(1, 10).intValue());
        test2BST.insert(1, 11);
        assertEquals(11, test2BST.findByValue(1, 11).intValue());
        test2BST.insert(30, 12);
        assertEquals(12, test2BST.findByValue(30, 12).intValue());
        test2BST.insert(30, 13);
        assertEquals(13, test2BST.findByValue(30, 13).intValue());
        assertEquals(6, test2BST.findByValue(30, 6).intValue());
    }
