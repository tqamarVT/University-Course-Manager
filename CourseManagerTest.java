...
// testCourseManager.clearcoursedata();
        ...
        assertFuzzyEquals(
            "Course Load Failed. You have to load Student Information file first.\r\n"
                ...
                + "CS3114 Course has been successfully loaded.\r\n"
                + "switch to section 1\r\n" + "section 1 dump:\r\n"
                + "BST by ID:\r\n" + "020380028, Sage Forbes, score = 4 \r\n"
                + "394691224, Aubrey Williamson, score = 100\r\n"
                + "977159896, Naomi Cote, score = 97 \r\n" + "BST by name:\r\n"
                ...
                + "section 1 dump:\r\n" + "BST by ID:\r\n" + "BST by name:\r\n"
                + "BST by score:\r\n" + "Size = 0\r\n"
                + "cs3114course Course has been successfully loaded.\r\n"
                + "switch to section 1\r\n" + "section 1 dump:\r\n"
                + "BST by ID:\r\n" + "020380028, Sage Forbes, score = 4   \r\n"
                + "239721905, Aileen Ford, score = 91   \r\n"
                + "394691224, Aubrey Williamson, score = 100   \r\n"
                ...
                + "394691224, Aubrey Williamson, score = 100  \r\n"
                + "Size = 3\r\n"
                + "CS3114_2 Course has been successfully loaded.\r\n"
