...
// assertFuzzyEquals(
// "Winter Hodge insertion failed. Wrong student information. ID doesn't
// exist\r\n",
// systemOut().getHistory());
// systemOut().clearHistory();
...
// assertFuzzyEquals(
// "Sandra Duncan insertion failed. Wrong student information. ID belongs to
// another student",
// systemOut().getHistory());
// systemOut().clearHistory();
...
// assertFuzzyEquals(
// "score command can only be called after an insert command or a successful
...
// }
    ...
    /**
     * Test the TAs and custom sample input file for all the various methods and
     * conditions.
     */

    public void testSampleInput() {
        systemOut().clearHistory();
        Parser.parseFile("TQsampleInput.txt");
        assertFuzzyEquals("Course Load Failed. You have to load "
            + "Student Information file first.\r\n"
            + "studentrandomcsv successfully loaded \r\n"
            + "random Course has been successfully loaded.\r\n"
            + "switch to section 1\r\n" + "section 1 dump:\r\n"
            + "BST by ID:\r\n" + "020380028, Sage Forbes, score = 4 \r\n"
            + "394691224, Aubrey Williamson, score = 100\r\n"
            + "977159896, Naomi Cote, score = 97 \r\n" + "BST by name:\r\n"
            ...
            + "Sandra Duncan is already registered "
            + "in a different section\r\n"
            + "Aileen Ford insertion failed. Wrong student information."
            + " ID doesn't exist\r\n"
            + "Caleb Foley insertion failed. Wrong student information."
            ...
            + "student with ID 291935757\r\n"
            + "score command can only be called after"
            ...
            + "section 1 dump:\r\n" + "BST by ID:\r\n" + "BST by name:\r\n"
            + "BST by score:\r\n" + "Size = 0\r\n"
            + "randomCourse3 Course has been successfully loaded.\r\n"
            + "switch to section 1\r\n" + "section 1 dump:\r\n"
            + "BST by ID:\r\n" + "020380028, Sage Forbes, score = 4   \r\n"
            + "bst by name\r\n" + "020380028 sage forbes score 4\r\n"
            + "bst by score\r\n" + "020380028 sage forbes score 4\r\n"
